  ...
  return (
    <Container className="w-full py-32">
      ...
      <p className="text-base md:text-lg text-muted-foreground mb-10 max-w-2xl">
        ...
        alias dicta numquam ducimus sit porro laboriosam ea? Consequatur, porro
        repudiandae! Nobis molestiae fuga eius similique, quod nesciunt commodi
        est, aut in illo quo exercitationem assumenda voluptatum dolorem modi
        enim provident possimus?{" "}
      </p>
